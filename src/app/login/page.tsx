        ...
        <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
          ...
          <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg">
                &ldquo;This web app has saved me countless hours of research
                work and helped me acquire new skills much faster and more
                efficient.&rdquo;
              </p>
              <footer className="text-sm">Arman Suleimenov</footer>
            </blockquote>
          </div>
        </div>
